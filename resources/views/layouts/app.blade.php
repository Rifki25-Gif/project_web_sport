...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="@yield('description', 'Your one-stop shop for the best athletic footwear.')">
        ...
        <meta property="og:description" content="@yield('description', 'Your one-stop shop for the best athletic footwear.')">
        ...
        <meta property="twitter:description" content="@yield('description', 'Your one-stop shop for the best athletic footwear.')">
